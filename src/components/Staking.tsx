...
import { pooladd, token, rinkebyAddress } from '../wallet/addresses';
import ModalConnect from './GeneralComponents/ModalConnect';
import Sidebar from './GeneralComponents/Sidebar';
import StakeCard from './StakingComponents/StakeCard';
import {calculateAP, loadContract, getPrice , round, formatNumber} from '../utils';
      ...
      <div className="container-fluid">
        ...
        <div className="row mt-5">
          ...
          <div className="right">
            ...
            <a href={rinkebyAddress + pooladd} className="badge">Contract Testnet <i className="fa fa-external-link-alt" /></a>
                          ...
                          <div className="col-md-12">
                            ...
                            <div className="input-group">
                              ...
                              <div className="input-group-append">
                                <a href={rinkebyAddress + pooladd} className="
                        ...
                        <div className="row mt-3">
                          <div className="col-md-12">
                            ...
                            <div className="input-group">
                              ...
                              <div className="input-group-append">
                                <a href={rinkebyAddress + token} className="
                                    input-group-text input-group-about-text
                                  " id="basic-addon2"><i className="fa fa-external-link-alt" /></a>
                              </div>
                            </div>
